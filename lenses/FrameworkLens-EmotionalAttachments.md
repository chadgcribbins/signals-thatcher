...
They do not need to be rational, efficient, or goal oriented.
...
For each Love Driver, populate the following sections:

### 1. Love Driver Statement
A concrete, human, emotionally recognisable description.

Written as:
- “People love this hotel because it makes them feel…”
- “People become attached to this hotel when…”

Avoid abstract hospitality language unless the evidence demands it.

### 2. Emotional Payoff
What emotional state or feeling this driver reliably creates.
...
- feeling worldly
- feeling taken care of without being managed

### 3. Situational Triggers
The moments or contexts where this Love Driver becomes most salient.
...
- moments of stress or vulnerability

### 4. Evidence Anchors
Cite supporting evidence using disciplined labels:
- [EVIDENCE] direct memory, quote, or interview insight
- [INFERENCE] synthesis across multiple memories
- [JUDGMENT] interpretation where evidence is partial

Where possible, include named memory holders, for example:
“[EVIDENCE] Sarah describes choosing this hotel again because ‘they remembered my coffee order and didn’t make a thing of it.’”

### 5. What People Would Miss If It Was Gone
Describe the sense of loss if this Love Driver disappeared.

This helps distinguish core attachment from nice-to-haves.

### 6. Tensions or Trade-offs
Surface any conflicts this Love Driver introduces.
...
## Desired Effect
The output should:
- Feel unmistakably grounded in real people and real memories.
...
Credible, resonant insight is.

## Confidence & Limitations
Where appropriate, the synthesis should:
- Distinguish memory-led attachment from trend-influenced expectations.
- Flag where additional memory collection would materially change conclusions.
- Avoid over-rationalising emotional drivers into operational language.
